...
@NgModule({
  ...
  declarations: [HomeComponent, FerroviaireComponent, BureautiqueComponent, SupportComponent, CatalogueComponent, Bloctheme1Component, Bloctheme2Component, EquipementComponent]
})
